...
const Sidebar = ({ setShowEmployeeForm, setShowPayrollForm, handleLogout, user }) => {
  return (
    <aside className="w-50 bg-gradient-to-l from-white to-slate-50 dark:from-[#22285E] dark:to-[#191D50] shadow-xl h-screen fixed top-0 left-0 flex flex-col border-r border-slate-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
      <div className="p-6 pb-4 border-b border-slate-100 dark:border-none">
      ...
      <nav className="flex-1 p-4 overflow-y-auto">
        ...
        <ul className="space-y-1">
          ...
          <li>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="bg-blue-50 dark:bg-green-900/30 p-2 rounded-xl">
